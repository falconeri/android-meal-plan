...
public class OnBoardTargetGenderActivity extends AppCompatActivity {
    Button btnStart;
    RadioGroup radioGrp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_on_board_target_gender);
        ...
        nextIntent = new Intent(getApplicationContext(), OnBoardTargetLevelActivity.class);
        btnStart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // save preferences
                savePreference(getApplicationContext(), Constants.JF_CURRENT_GENDER, target);
